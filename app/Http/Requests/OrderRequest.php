...
class OrderRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'file.required_if' => 'The file is required.',
            'school.required_if' => 'The school is required.',
            'set.required_if' => 'The set is required.',

            'file_school.required_if' => 'The school is required.',
            'file_top.required' => 'The top is required when the bottom is empty.',
            'file_bottom.required' => 'The bottom is required when the top is empty.',
            
            'top.required' => 'The top is required when the bottom is empty.',
            'bottom.required' => 'The bottom is required when the top is empty.',
            ...
            'blouse_bust.required_if' => 'The blouse bust measurement is required when uniform top is blouse.',
            'blouse_length.required_if' => 'The blouse length measurement is required when uniform top is blouse',
            'blouse_waist.required_if' => 'The blouse waist measurement is required when uniform top is blouse',
            'blouse_figure.required_if' => 'The blouse figure measurement is required when uniform top is blouse',
            'blouse_hips.required_if' => 'The blouse hips measurement is required when uniform top is blouse',
            'blouse_shoulder.required_if' => 'The blouse shoulder measurement is required when uniform top is blouse',
            'blouse_sleeve.required_if' => 'The blouse sleeve measurement is required when uniform top is blouse',
            'blouse_arm_hole.required_if' => 'The blouse arm hole measurement is required when uniform top is blouse',
            'blouse_lower_arm_girth.required_if' => 'The blouse lower arm girth measurement is required when uniform top is blouse',
